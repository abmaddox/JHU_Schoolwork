...
<html lang="en">
    ...
    <body>
        ...
        <main>
            ...
            <br/><br/>
             We are currently booking hikes between <%= Rates.DEFAULT_MIN_YEAR %> and <%= Rates.DEFAULT_MAX_YEAR %>.  
            To put in your starting date, use the format MM/DD/YYYY.</p>
            <form action="https://web3.jhuep.com/maddox_a_hw14/api/Form" method="post">
                <p>Hike: 
